...
export declare class TextToSpeechStreamingSocket {
     ...
     * - Flat params: { speaker: "anushka", language_code: "hi-IN", ... }
     * - Wire format: { type: "config", data: { speaker: "anushka", language_code: "hi-IN", ... } }
     */
    configureConnection(config: SarvamAI.ConfigureConnection | {
        language_code: SarvamAI.ConfigureConnection.Data.LanguageCode;
