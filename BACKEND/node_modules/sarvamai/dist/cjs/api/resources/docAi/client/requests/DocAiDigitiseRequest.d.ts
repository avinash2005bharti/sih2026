 ...
 *     {}
 */
export interface DocAiDigitiseRequest {
    ...
    output_format?: DocAiDigitiseRequest.OutputFormat;
    /** Nature of the document content. */
    content_type?: DocAiDigitiseRequest.ContentType;
    /** Model to use for digitisation. */
    model?: string;
}
export declare namespace DocAiDigitiseRequest {
    /** Output format of the digitised document. */
    const OutputFormat: {
        readonly Html: "html";
        readonly Md: "md";
    ...
    const ContentType: {
        ...
        readonly Handwritten: "handwritten";
