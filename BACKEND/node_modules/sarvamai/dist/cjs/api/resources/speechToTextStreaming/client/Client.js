...
class SpeechToTextStreamingClient {
    ...
    connect(args) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            const { "language-code": languageCode, model, mode, input_audio_codec: inputAudioCodec, sample_rate: sampleRate, high_vad_sensitivity: highVadSensitivity, vad_signals: vadSignals, flush_signal: flushSignal, headers, debug, reconnectAttempts, } = args;
            const _queryParams = {};
            ...
            let _authRequest;
            try {
                _authRequest = yield this._options.authProvider.getAuthRequest();
            }
            catch (error) {
                // Fall back to the key passed via connect args when the client itself has no credentials.
                if (args["Api-Subscription-Key"] == null) {
                    throw error;
                }
            }
            const _headers = (0, headers_js_1.mergeHeaders)(_authRequest === null || _authRequest === void 0 ? void 0 : _authRequest.headers, (0, headers_js_1.mergeOnlyDefinedHeaders)({ "Api-Subscription-Key": args["Api-Subscription-Key"] }), headers);
