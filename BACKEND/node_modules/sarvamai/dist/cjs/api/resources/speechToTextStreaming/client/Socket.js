...
class SpeechToTextStreamingSocket {
    ...
    /**
     * Set a prompt (e.g. domain-specific words) to improve transcription accuracy.
     * Convenience wrapper over `sendConfigMessage`.
     */
    setPrompt(prompt) {
        this.sendConfigMessage({ type: "config", prompt });
    }
