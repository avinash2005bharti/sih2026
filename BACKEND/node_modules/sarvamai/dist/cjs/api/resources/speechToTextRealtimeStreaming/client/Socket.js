...
exports.SpeechToTextRealtimeStreamingSocket = void 0;
const core = __importStar(require("../../../../core/index.js"));
const json_js_1 = require("../../../../core/json.js");
class SpeechToTextRealtimeStreamingSocket {
    constructor(args) {
        this.eventHandlers = {};
        this.handleOpen = () => {
            var _a, _b;
    ...
    sendRealtimeAudioInput(message) {
        this.assertSocketIsOpen();
        this.sendJson(message);
    }
    sendRealtimeSpeechStart(message) {
        this.assertSocketIsOpen();
        this.sendJson(message);
    }
    sendRealtimeSpeechEnd(message) {
        this.assertSocketIsOpen();
        this.sendJson(message);
    }
    sendRealtimeFlush(message) {
        this.assertSocketIsOpen();
        this.sendJson(message);
    }
    sendRealtimeConfigUpdate(message) {
        this.assertSocketIsOpen();
        this.sendJson(message);
    }
    sendRealtimeEnd(message) {
        this.assertSocketIsOpen();
        this.sendJson(message);
    }
    sendRealtimePing(message) {
        this.assertSocketIsOpen();
        this.sendJson(message);
    }
...
exports.SpeechToTextRealtimeStreamingSocket = SpeechToTextRealtimeStreamingSocket;
