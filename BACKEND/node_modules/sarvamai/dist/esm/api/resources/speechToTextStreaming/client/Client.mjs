...
export class SpeechToTextStreamingClient {
    ...
    connect(args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _headers = mergeHeaders(_authRequest === null || _authRequest === void 0 ? void 0 : _authRequest.headers, mergeOnlyDefinedHeaders({ "Api-Subscription-Key": args["Api-Subscription-Key"] }), headers);
