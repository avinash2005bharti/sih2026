...
export class SpeechToTextJobClient {
    constructor(options = {}) {
     ...
     * @param params.model - The model to use for transcription (default: "saaras:v3")
     ...
     * @param params.mode - Output mode for **saaras:v3** / **saaras:v4** (e.g. transcribe, translate, verbatim)
    ...
    createJob() {
        return __awaiter(this, arguments, void 0, function* (params = {}, requestOptions) {
            const { model = "saaras:v3", withDiarization = false, withTimestamps = false, languageCode, numSpeakers, mode, callback, } = params;
