...
export interface CreateDocumentJobRequest {
    ...
    genre?: SarvamAI.DocumentGenre;
    /** Target languages (BCP-47). */
    target_language_codes: SarvamAI.DocumentLanguage[];
    /**
    ...
    language_specific_guidelines?: Record<string, string | undefined>;
}
