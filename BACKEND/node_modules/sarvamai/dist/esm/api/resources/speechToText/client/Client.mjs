...
export class SpeechToTextClient {
    ...
    __transcribe(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (request.with_timestamps != null) {
                _body.append("with_timestamps", (_a = request.with_timestamps) === null || _a === void 0 ? void 0 : _a.toString());
            }
            ...
            const _response = yield core.fetcher({
                url: core.url.join((_c = (yield core.Supplier.get(this._options.baseUrl))) !== null && _c !== void 0 ? _c : ((_d = (yield core.Supplier.get(this._options.environment))) !== null && _d !== void 0 ? _d : environments.SarvamAIEnvironment.Production).base, "speech-to-text"),
                method: "POST",
                headers: _headers,
