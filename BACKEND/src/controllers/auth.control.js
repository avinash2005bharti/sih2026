...
async function registerUser(req, res) {
    ...
    try {
        ...
        const allowedRoles = ["admin", "operator", "engineer", "analyst", "viewer"];
        const assignedRole = allowedRoles.includes(role) ? role : "operator";
        const isUserAdmin = assignedRole === "admin" || Boolean(isAdmin);
