...
const AgentsPage = () => {
  ...
  const loadData = async () => {
    setLoading(true);
    try {
      const [agentsRes, modelsRes, ollamaRes] = await Promise.allSettled([
        agentApi.getAgents(),
        modelApi.getModels(),
        modelApi.getOllamaModels(),
      ]);
      ...
      if (ollamaRes.status === 'fulfilled' && ollamaRes.value?.models) {
        setOllamaModels(ollamaRes.value.models);
      }
    } catch (e) {
